            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        className="flex items-center gap-1 px-3.5 py-2 bg-slate-900 border border-slate-800 disabled:opacity-40 text-slate-300 hover:text-slate-200 rounded-lg text-xs font-semibold transition-colors"
                    >
                            ...
                            >
                                ...
                                <div className="flex-1 space-y-1">
                                    <div className="flex items-start justify-between gap-4">
                                        <h4 className={`text-xs font-bold ${a.read ? 'text-slate-400' : 'text-slate-200'}`}>
                                            {a.title}
                                        </h4>
