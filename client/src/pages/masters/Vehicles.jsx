    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-xl font-bold text-slate-200 uppercase tracking-wider">Vehicles</h1>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    <div className="w-full max-w-sm rounded-2xl p-5 glass-modal border-rose-500/20">
                        <div className="flex items-start gap-3 mb-4">
                            ...
                            <div>
                                <h3 className="text-slate-200 font-bold text-sm">De-register Vehicle?</h3>
